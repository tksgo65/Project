...
public class OrderSQL {
	public final static String ORDER_DELETE_BY_USERID = "delect from orders where userid=?";
	public final static String ORDER_DELETE_BY_O_NO = "delect from dorders where o_no=?";
	public final static String ORDER_INSERT = "insert into orders(o_no,o_name,o_date,o_price,userid) values (orders_o_no_SEQ.nextval,?,sysdate,?,?)";
